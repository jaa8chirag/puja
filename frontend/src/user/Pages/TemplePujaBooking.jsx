  ...
  const contributionList = [
    {
      ...
      icon: <Shirt size={16} />,
      sub: getDescription("Vastra Dan") || "Donate clothes to the needy",
    },
    {
      id: "Anna Dan",
      title: "Anna Dan",
      ...
      icon: <Coffee size={16} />,
      sub: getDescription("Anna Dan") || "Provide meals to the hungry",
    },
    {
      id: "Deep Dan",
      title: "Deep Dan",
      ...
      icon: <Flame size={16} />,
      sub: getDescription("Deep Dan") || "Light lamps at sacred temples",
    },
    {
      id: "Brahmin Dan",
      title: "Brahmin Dan",
      ...
      sub: getDescription("Brahmin Dan") || "Feed Brahmins after ceremony",
    },
    {
      id: "Vidya Dan",
      title: "Vidya Dan",
      price: getPrice("Vidya Dan"),
      icon: <BookOpen size={16} />,
      sub: getDescription("Vidya Dan") || "Support education for children",
    },
    {
      id: "Aushadhi Dan",
      title: "Aushadhi Dan",
      price: getPrice("Aushadhi Dan"),
      icon: <Activity size={16} />,
      sub: getDescription("Aushadhi Dan") || "Donate medicines to the sick",
    },
    {
      id: "Jal Dan",
      title: "Jal Dan",
      price: getPrice("Jal Dan"),
      icon: <Droplets size={16} />,
      sub: getDescription("Jal Dan") || "Provide clean water to those in need",
    },
    {
      id: "Vriksh Dan",
      title: "Vriksh Dan",
      price: getPrice("Vriksh Dan"),
      icon: <Leaf size={16} />,
      sub: getDescription("Vriksh Dan") || "Plant trees for a greener future",
    },
    {
      id: "Aashray Dan",
      title: "Aashray Dan",
      price: getPrice("Aashray Dan"),
      icon: <Home size={16} />,
      sub: getDescription("Aashray Dan") || "Support shelter for the homeless",
    },
    {
      id: "Jeev Daya",
      title: "Jeev Daya",
      price: getPrice("Jeev Daya"),
      icon: <Bird size={16} />,
      sub: getDescription("Jeev Daya") || "Feed and care for animals",
    },
    {
      id: "Gau Seva",
      title: "Gau Seva",
      ...
      sub: getDescription("Gau Seva") || "Feed the Gau Mata",
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <aside className="hidden lg:block lg:col-span-4 lg:sticky lg:top-[100px] self-start z-30">
              <div className="bg-white rounded-3xl border border-orange-200 p-6 shadow-xl shadow-orange-50/50 space-y-6">
                ...
                <div className="space-y-4 pt-2">
                  ...
                  <div className="flex flex-col border-y border-orange-200 py-3 px-1">
                    ...
                    <p className="text-[12px] text-gray-500 mt-1 ml-7 leading-snug">
                      {Array.from(contributionOptions).find(
                        (c) => c.name === "Temple Donation",
                      )?.description ||
                  ...
                  {discountAmount > 0 && (
                    <div className="flex justify-between items-center text-[12px] font-bold text-green-600 px-1">
                ...
                {/* Trust + Pay */}
                <div className="space-y-4">
                  <div className="flex items-center text-center justify-center bg-yellow-50/60 px-4 py-3 rounded-xl border border-yellow-100">
                    <div className="flex items-center text-center gap-1.5 text-[10px] font-bold text-gray-700 uppercase">
...
const MobileSummarySection = ({
  ...
  <div className="space-y-5">
    ...
    <div className="space-y-3 pt-1">
      ...
      {discountAmount > 0 && (
        <div className="flex justify-between items-center text-[13px] font-bold text-green-600 px-1 pt-1">
