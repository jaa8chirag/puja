...
//   useEffect(() => {
//     // Single nahi hai (Couple/Family) tabhi members fetch karo
...
//         {/* Header */}
//         <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800 bg-[#131e32] sticky top-0 z-10">
//           <div>
...
//                     <tr
//                       key={b.id}
//                       onClick={() => setSelectedBooking(b)} // ✅ NEW — row click
...
//               <div
//                 key={b.id}
//                 onClick={() => setSelectedBooking(b)} // ✅ NEW — card click
