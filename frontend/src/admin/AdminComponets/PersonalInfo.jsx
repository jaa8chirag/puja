...
//       {toast && (
//         <div
//           className={`fixed bottom-6 right-6 z-[60] px-5 py-3 rounded-2xl shadow-2xl text-xs font-bold flex items-center gap-3 border ${
//             toast.type === "error"
...
//                   </td>
//                   <td className="px-5 py-3">
//                     <span className="text-slate-400 text-xs">{rec.email}</span>
//                   </td>
//                   <td className="px-5 py-3">
...
//                           rec.is_active === 1
//                             ? "bg-slate-800 hover:bg-slate-500/20 hover:text-slate-400 text-slate-400"
//                             : "bg-slate-800 hover:bg-emerald-500/20 hover:text-emerald-400 text-slate-400"
//                         }`}
//                         title={rec.is_active === 1 ? "Deactivate" : "Activate"}
//                       >
...
//                           });
//                         }}
//                         className="p-2 rounded-xl bg-slate-800 hover:bg-orange-500/20 hover:text-orange-400 text-slate-400 transition-all"
//                       >
//                         <Pencil size={13} />
//                       </button>
//                       <button
...
//                         className="p-2 rounded-xl bg-slate-800 hover:bg-rose-500/20 hover:text-rose-400 text-slate-400 transition-all disabled:opacity-50"
//                       >
...
//               className="mt-5 w-full py-3 bg-orange-500 hover:bg-orange-400 disabled:opacity-50 text-white text-xs font-black rounded-2xl transition-all flex items-center justify-center gap-2"
//             >
//               {actionLoading === "add" ? (
...
import {
  ...
  XCircle,
  Power,
  MessageSquare, // FAQ ke liye icon
} from "lucide-react";
import Pagination from "../../Components/Pagination";
...
const ModalField = ({
  ...
  value,
  onChange,
  isTextArea = false, // FAQ answer ke liye
}) => (
  <div className="relative">
...
const PersonalInfo = () => {
  ...
  // ── PERSONAL INFO ACTIONS (Existing) ──
  const deleteRecord = async (id) => {
    if (!window.confirm("Are you sure you want to delete this record?")) return;
    setActionLoading(id);
    try {
